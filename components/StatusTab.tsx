    ...
    <div className="flex gap-[16px] border-b-[1px] border-[var(--color-border)]">
      {tabs.map((tab) => (
        <button
          ...
          className={`relative pb-[8px] text-[14px] font-[family-name:var(--font-ui)] transition-colors focus-visible:outline-none focus-visible:ring-[2px] focus-visible:ring-[var(--color-focus)] focus-visible:ring-offset-[2px] ${
            activeTab === tab.id
              ? "text-[var(--color-ink)]"
